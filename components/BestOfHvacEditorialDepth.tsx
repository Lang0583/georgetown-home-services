...
export default function BestOfHvacEditorialDepth() {
  return (
    <section className="mt-10 space-y-8 rounded-xl border border-ink/10 bg-surface p-6 shadow-sm md:p-8">
      ...
      <div>
        <h2 className="text-2xl font-semibold tracking-tight text-ink">Central Texas climate realities</h2>
        <p className="mt-3 text-sm leading-relaxed text-muted">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted">
          ...
          <Link href="/services/hvac-georgetown-tx" className="font-semibold text-brand hover:underline">
      ...
      <div>
        <h2 className="text-2xl font-semibold tracking-tight text-ink">Red flags when hiring HVAC help</h2>
