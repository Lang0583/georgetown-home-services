...
export type NeighborhoodHailPage = {
  ...
  /** Article body: paragraphs, headings, lists—includes `/services/roofing` CTA. */
  bodyHtml: string;
  faqs: Faq[];
...
<p>Review tear-off, underlayment, and nail-pattern expectations on the <a href="/services/roofing">Georgetown roofing hub</a>, then invite two Wolf-Ranch-familiar companies from <a href="/best/best-roofers-georgetown-tx">Best Roofers in Georgetown, TX</a> for apples-to-apples bids. Pair those visits with the FAQ flow in <a href="/blog/hail-damage-georgetown-williamson-may-2026">May 2026 Williamson County hail coverage</a> so questions stay consistent across appointments. If your HOA asks for palette or shingle-class approvals, start that packet now—Storm season queues compound when architectural review boards only meet monthly, and you do not want a green-lit insurance scope held up by paperwork you could have filed earlier.</p>
`.trim(),
    faqs: [
      {
