...
export const NEIGHBORHOOD_HOME_SERVICES_HUBS: NeighborhoodHomeServicesHub[] = [
  {
    ...
    metaDescription:
      "Plumber, HVAC, and roofer guidance for Sun City, Georgetown TX: slab plumbing, summer AC load, and storm-ready roofs—compare costs, FAQs, and local pros compiled from public business data.",
    introHtml: `
...
<p>Use the trade-specific Georgetown service guides linked above when a single system demands more detail than a tri-trade overview can fairly cover—especially for sewer camera outcomes, attic static pressure maps, or ridge-level roofing photos that belong in your home file.</p>
    `.trim(),
    lastUpdated: DIRECTORY_PAGES_LAST_UPDATED,
  },
  {
...
<p>This hub is designed for consolidated intent: neighbors typing variations of plumber, AC, and roofing needs alongside Georgetown Village and Georgetown TX. The content is educational, not a dispatch service—Georgetown Home Services does not schedule contractors. Use the pricing module for orientation, the FAQ content for better hiring conversations, and the directory buttons to compare companies operating in Williamson County. For storm documentation, see the <a href="/neighborhoods/georgetown-village/hail-damage">Georgetown Village hail hub</a> and our May 2026 Williamson County hail guide.</p>
