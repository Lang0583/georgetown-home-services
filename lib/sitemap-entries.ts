...
export function buildSitemapEntries(): MetadataRoute.Sitemap {
  ...
  for (const { path, priority } of [
    ...
    { path: "/methodology.md", priority: 0.4 },
    { path: "/best.md", priority: 0.4 },
    { path: "/costs.md", priority: 0.4 },
    { path: "/water.md", priority: 0.4 },
    { path: "/reports/williamson-county-license-check", priority: 0.7 },
    { path: "/reports/williamson-county-license-check.md", priority: 0.4 },
    { path: "/llms.txt", priority: 0.4 },
    { path: "/editorial-policy", priority: 0.5 },
    { path: "/service-areas", priority: 0.5 },
    { path: "/zip", priority: 0.7 },
    { path: "/contact", priority: 0.5 },
    { path: "/for-contractors", priority: 0.6 },
