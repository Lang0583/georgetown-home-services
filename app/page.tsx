...
/**
 * Regenerate the static homepage at most once per day (ISR). Keeps the
 * `Updated <Month> <Year>` label inside `HomeTrustBar` from drifting more
 * than 24 hours past the actual calendar month, without forcing a full
