        ...
        <section className="py-10 md:py-12">
          ...
          <div className="flex flex-col gap-10">
            <div>
              ...
              <h1 className="mt-3 text-4xl font-bold tracking-tight text-ink md:text-5xl">House Cleaning in Georgetown, TX</h1>
              <LastUpdated lastUpdated={lastUpdated} />
              <SpeakableJsonLd />
              <KeyTakeaways items={tradeHubTakeaways("house-cleaning")} speakable />
              ...
              <div className="mt-4 flex flex-wrap gap-4 text-sm font-semibold">
                <Link href="/best/best-house-cleaning-services-georgetown-tx" className="text-brand hover:underline">
            ...
            {supporting.length ? (
              <section>
                <h2 className="text-3xl font-semibold tracking-tight text-ink">Supporting house cleaning pages</h2>
                <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2">
                  {supporting.map((s) => (
            ...
            <TradeHubSubServiceLinks parentHubPath="/services/house-cleaning" />
