          ...
          <div className="flex flex-col gap-10">
            <div>
              ...
              <div className="mt-4 flex flex-wrap gap-4 text-sm font-semibold">
                <Link href="/best/best-landscaping-companies-georgetown-tx" className="text-brand hover:underline">
            ...
            {supporting.length ? (
              <section>
                <h2 className="text-3xl font-semibold tracking-tight text-ink">Supporting landscaping pages</h2>
                <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2">
                  {supporting.map((s) => (
