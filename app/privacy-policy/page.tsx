...
export default function PrivacyPolicyPage() {
  ...
  return (
    ...
    >
      <section>
        <h2 className="text-2xl font-semibold tracking-tight text-ink">Storm / inspection lead requests</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold tracking-tight text-ink">Site feedback storage</h2>
        <p className="mt-3 text-sm leading-relaxed text-muted">
      ...
      <section>
        <h2 className="text-2xl font-semibold tracking-tight text-ink">Children&apos;s privacy</h2>
        <p className="mt-3 text-sm leading-relaxed text-muted">
      ...
      <section>
        <h2 className="text-2xl font-semibold tracking-tight text-ink">Google AdSense and advertising</h2>
        <p className="mt-3 text-sm leading-relaxed text-muted">
      ...
      <section>
        <h2 className="text-2xl font-semibold tracking-tight text-ink">Google Analytics</h2>
        <p className="mt-3 text-sm leading-relaxed text-muted">
      ...
      <section>
        <h2 className="text-2xl font-semibold tracking-tight text-ink">Affiliate and partner links</h2>
        <p className="mt-3 text-sm leading-relaxed text-muted">
      ...
      <section>
        <h2 className="text-2xl font-semibold tracking-tight text-ink">Cookies and similar technologies</h2>
        <p className="mt-3 text-sm leading-relaxed text-muted">
      ...
      <section>
        <h2 className="text-2xl font-semibold tracking-tight text-ink">Information we collect directly</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold tracking-tight text-ink">How we use information</h2>
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-relaxed text-muted">
      ...
      <section>
        <h2 className="text-2xl font-semibold tracking-tight text-ink">Third-party links</h2>
        <p className="mt-3 text-sm leading-relaxed text-muted">
      ...
      <section>
        <h2 className="text-2xl font-semibold tracking-tight text-ink">Contact</h2>
        <p className="mt-3 text-sm leading-relaxed text-muted">
          For privacy-related requests, contact us at{" "}
          <a className="font-medium text-brand underline-offset-4 hover:underline" href={`mailto:${email}`}>
            {email}
          </a>
      ...
      <section>
        <h2 className="text-2xl font-semibold tracking-tight text-ink">Updates</h2>
        <p className="mt-3 text-sm leading-relaxed text-muted">
